...
export declare type External = string | {
    [require: string]: string | boolean;
} | ((context, request, callback: (err: Error, result) => void) => void) | RegExp | Array<string | {
    [require: string]: string | boolean;
} | ((context, request, callback: (err: Error, result) => void) => void) | RegExp>;
