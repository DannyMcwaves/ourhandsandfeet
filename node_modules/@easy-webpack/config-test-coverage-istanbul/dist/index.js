...
module.exports = function istanbul(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.include, include = _c === void 0 ? undefined : _c, _d = _b.exclude, exclude = _d === void 0 ? undefined : _d;
    return function istanbul() {
        return {
            module: {
                postLoaders: core_1.get(this, 'module.postLoaders', []).concat([{
                        test: /\.(js|ts)$/,
